...
Wenn Sie Ihr Dataset für die Veröffentlichung terminiert haben ist das anschliessend auch inder Detailansicht
des Datasets zu sehen:

.. figure:: ../../../_static/images/publizieren/dataset/dataset-terminiert.png
   :alt: Dataset für die Veröffentlichung terminiert

Sobald Ihr Dataset veröffenlicht ist, kann es auch im Frontend der Abnahmeumgebung angesehen werden.
Bitte prüfen Sie Ihre Daten auch hier nochmal. Sie gelangen zu der Datenansicht Ihres Datasets im Frontend,
